...
# Test
userx = np.array([32, 16, 16, 17, 3, 28, 24, 37, 9, 37, 32, 5, 3, 33, 6, 23, 27, 5, 39, 29,
...
usery = np.array([27, 22, 32, 10, 17, 9, 22, 2, 30, 12, 12, 24, 35, 16, 39, 16, 15, 16, 23, 23,
...
rrhx = np.array([16, 15, 7, 27, 38, 9])
rrhy = np.array([19, 38, 35, 21, 1, 0])
ls_pop = 1000
rrh = 6
...
t = local_search(users, userx, usery, rrh, rrhx, rrhy, Q, ls_pop)
print(t)
